...
*********************************************************************      
      ...
      INTEGER I,IFAIL,OMGFLAG,MAFLAG,PFLAG,Q2FIX
...
!      WRITE(17,*)AKMES,-3d0/(16d0*PI**2)*DHINP*MSUSYEFF
!      WRITE(17,*)MSMES,1d0/(16d0*PI**2)**2*(1.4d0*DHINP**2
!     . -.2d0*(16d0*G3MES+6d0*G2MES+10d0/3d0*G1MES)*DHINP
!     . -4d0*KMES**2*DHINP)*MSUSYEFF**2
!      WRITE(17,*)
     ...
     .        "g1(MLANDAU), (GUT normalization)"
      ...
      WRITE(17,901) 3,FTMES(3),"PM=DELTA_H"
      WRITE(17,901) 4,FTMES(4),"PM=ALAMBDA"
      WRITE(17,901) 5,FTMES(5),"PM=XIF"
      WRITE(17,901) 6,FTMES(6),"PM=XIS"
      WRITE(17,901) 7,FTMES(7),"PM=MUP"
      WRITE(17,901) 8,FTMES(8),"PM=MSP"
      WRITE(17,901) 9,FTMES(9),"PM=LAMBDA"
      WRITE(17,901) 10,FTMES(10),"PM=KAPPA"
      WRITE(17,901) 11,FTMES(11),"PM=HTOP"
      WRITE(17,901) 12,FTMES(12),"PM=G1"
      WRITE(17,901) 13,FTMES(13),"PM=G2"
      WRITE(17,901) 14,FTMES(14),"PM=G3"
      WRITE(17,901) 15,FTMES(15),"PM=MMES"
      WRITE(17,901) 16,FTMES(16),"MAX"
      WRITE(17,914) 17,INT(FTMES(17)),"IMAX"
