...
//  printf("SUSY mass diff, Bs-bar{Bs} =%.2E[1/ps]\n", slhaValFormat("deltaM",0.,"531 1 %lf"));  
  ...
  System( HIGGSBOUNDS "/HiggsBounds  LandH SLHA 3 1  cpsuperh2_slha.out");
  slhaRead("cpsuperh2_slha.out",0);
...
system(" rm -f CPsuperH.in cpsuperh2_slha.out CPsuperH.out Key.dat nngg.in nngg.out"); 
