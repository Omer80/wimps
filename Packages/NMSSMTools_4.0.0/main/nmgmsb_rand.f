...
************************************************************************
      ...
      PARAMETER (NFL=16,NPROB=49,NPAR=25)
      INTEGER NFAIL(NFL),IFAIL,I,TOT,ITOT,NTOT,IDIM,IDUM
      INTEGER ITER,ITERMU,Q2FIX,OMGFLAG,MAFLAG
...
*   Beginning of the random scan
      ...
      ELSE
       ...
       IF(DHMIN.EQ.DHMAX)THEN
        DHINP=DHMIN
       ELSE
        DHINP=DHMIN+(DHMAX-DHMIN)*RAN2(IDUM)
       ENDIF
      ENDIF
...
*******************************************************************
      ...
      INTEGER NTOT,ISEED,N0,NLOOP,NBER,NPAR,OMGFLAG,MAFLAG,PFLAG,ERR
