...
! Mass uncertainties smaller than 0.1 GeV are not considered
 ...
 character(LEN=9),parameter :: vers='4.0.0'
...
! Mass uncertainties (variation) used in HB
 ...
 type dataset        
  ...
  double precision, allocatable :: BR_Hbb_SM(:),BR_Hmumu_SM(:),BR_Htautau_SM(:)  
  double precision, allocatable :: BR_HWW_SM(:),BR_HZZ_SM(:),BR_HZga_SM(:),BR_Hgaga_SM(:)
 ...
 subroutine HiggsBounds_info
  ...
  write(*,*)"~                                                        ~"
  write(*,*)"~    arXiv:0811.4169, arXiv:1102.1898, arXiv:1301.2345   ~"
  write(*,*)"~                                                        ~"  
